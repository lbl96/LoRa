...
#define SLAVE2_ADDR        0x02    //子设备1地址
#define SLAVE3_ADDR        0x03    //子设备1地址
...
/*参数相关宏定义*///偶数16进制对应只有1位为1，其他位为0
#define PRAM_R_TEMPERATURE 0x01    //只读取温度，第一位 0001
#define PRAM_R_HUMIDITY    0x02    //只读取湿度，第二位 0010
#define PRAM_R_BPM         0x04    //只读取心跳，第三位 0100
#define PRAM_R_ALL         0x07    //读取所有传感器，全为1 0111
